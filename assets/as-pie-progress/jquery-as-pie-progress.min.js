 ...
 */
!function (t, e) {
    if ("function" == typeof define && define.amd) define(["exports", "jQuery"], e); else if ("undefined" != typeof exports) e(exports, require("jQuery")); else {
        var i = {exports: {}};
    ...
    var s = i(e), r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        return typeof t
    } : function (t) {
        ...
        return s.default.each(e, function (t, e) {
            i.setAttribute(t, e)
        }), i
    }, h = function (t) {
    ...
    var v = function () {
        ...
        return a(t, [{
            ...
            key: "prepare", value: function () {
                p && (this.svg = new u("svg", {
                    version: "1.1",
                    preserveAspectRatio: "xMinYMin meet",
                    viewBox: "0 0 " + this.width + " " + this.height
                }), this.buildTrack(), this.buildBar(), (0, s.default)('<div class="' + this.classes.svg + '"></div>').append(this.svg).appendTo(this.$element))
            }
        }, {
            key: "buildTrack", value: function () {
                var t = this.size, e = this.size, i = e / 2, n = t / 2, s = this.options.barsize, r = new u("ellipse", {
                    rx: i - s / 2,
                    ry: n - s / 2,
                    cx: i,
                    cy: n,
            ...
            key: "_drawBar", value: function (t) {
                if (p) {
                    ...
                    var h = r + u * Math.PI * 2 / 100, l = n + o * Math.sin(r), f = n + o * Math.sin(h),
                        c = s - o * Math.cos(r), d = s - o * Math.cos(h), m = 0;
                    h - r > Math.PI && (m = 1);
                    var g = "M" + l + "," + c + " A" + o + "," + o + " 0 " + m + " 1 " + f + "," + d;
            ...
            key: "go", value: function (t) {
                var e = this;
                this._clear(), h(t) && (t = parseInt(t.replace("%", ""), 10), t = Math.round(this.min + t / 100 * (this.max - this.min))), "undefined" == typeof t && (t = this.goal), t > this.max ? t = this.max : t < this.min && (t = this.min), this.barGoal < t && this._drawBar(t);
                var i = e.now, n = o(), s = n + 100 * Math.abs(i - t) * e.options.speed / (e.max - e.min),
                    r = function r(a) {
                        var o = void 0;
                        if (a > s) o = t; else {
            ...
            key: "_jQueryInterface", value: function (e) {
                for (var i = this, n = arguments.length, a = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++) a[o - 1] = arguments[o];
                if ("string" == typeof e) {
                    var u = function () {
                        var t = e;
                        if (/^\_/.test(t)) return {v: !1};
                        if (!/^(get)$/.test(t)) return {
                            v: i.each(function () {
                        ...
                        return n && "function" == typeof n[t] ? {v: n[t].apply(n, a)} : void 0
                    }();
                    if ("object" === ("undefined" == typeof u ? "undefined" : r(u))) return u.v
                }
                return this.each(function () {
                    s.default.data(this, g) || s.default.data(this, g, new t(this, e))
                })
            }
        }]), t
    }();
    ...
    }), s.default.fn[g] = v._jQueryInterface, s.default.fn[g].constructor = v, s.default.fn[g].noConflict = function () {
